...
export const HelpPopover = () => {
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        socket.emit("message", { message, to: import.meta.env.VITE_ADMIN_ID, from: userId });
        setMessages((prev) => [
            ...prev,
    ...
    return (
        <div onClick={(e) => e.stopPropagation()}>
            <button
                ...
                className="fixed bottom-4 right-4 inline-flex items-center justify-center text-sm font-medium disabled:pointer-events-none disabled:opacity-50 border rounded-full w-12 h-12 md:w-16 md:h-16 bg-black hover:bg-gray-700 m-0 cursor-pointer border-gray-200 p-0 normal-case leading-5 hover:text-gray-900 z-20"
                type="button">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="28" className="md:w-[30px] md:h-[40px] text-white block border-gray-200 align-middle" viewBox="0 0 24 24" fill="none"
            ...
            <RenderIf condition={isOpen}>
                <div style={{ boxShadow: "0 0 #0000, 0 0 #0000, 0 1px 2px 0 rgb(0 0 0 / 0.05)" }}
                    className="z-20 fixed bottom-[calc(4rem+1.5rem)] right-0 mr-4 bg-white p-4 md:p-6 rounded-lg border border-[#e5e7eb] w-[calc(100vw-2rem)] md:w-[440px] h-[70vh] md:h-[634px]">

                    <div className="flex flex-col space-y-1.5 pb-6">
                        <h2 className="font-semibold text-lg tracking-tight">Morent Help Chat</h2>
                        <p className="text-sm text-[#6b7280] leading-3">Morent © 2026</p>
                    </div>
                    ...
                    <RenderIf condition={!isLoading}>
                        ...
                        <RenderIf condition={!!conversationData}>
                            <div ref={wrapperRef} className="pr-4 h-[474px] overflow-y-auto" style={{ minWidth: "100%" }}>
