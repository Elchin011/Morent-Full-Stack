...
const getByRentId = async (rentId: string) => {
    return await axiosInstance.get(`/reservation/rent/${rentId}`)
}


const reservationService = { create, getAll, changeStatus, cancel, getByRentId }
